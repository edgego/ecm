...
const createUsageExample = `  ecm -d create \
    --provider native \
    --name <cluster name> \
    --ssh-user <ssh-user> \
...
const joinUsageExample = `  ecm -d join \
    --provider native \
    --name <cluster name> \
    --ssh-user <ssh-user> \
    --ssh-key-path <ssh-key-path> \
...
const deleteUsageExample = `  ecm -d delete \
    --provider native \
    --name <cluster name>
`

const sshUsageExample = `  ecm ssh \
    --provider native \
    --name <cluster name>
`
