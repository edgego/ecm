...
func (d *Store) Register() {
	_ = d.DB.Callback().Create().After("gorm:create").Register("gorm:ecm_create", d.createHandler)
	_ = d.DB.Callback().Update().After("gorm:update").Register("gorm:ecm_update", d.updateHandler)
}
