...
const (
	...
	// StatusUpdating instance updating status.add by edgego
	StatusUpdating = "Updating"
	// UsageInfoTitle usage info title.
	UsageInfoTitle = "=========================== Prompt Info ==========================="
	// UsageContext usage info context.
	UsageContext = "Use 'ecm kubectl config use-context %s'"
	// UsagePods usage  info pods.
	UsagePods = "Use 'ecm kubectl get pods -A' get POD status`"
...
var (
	...
	CfgPath = filepath.Join(utils.UserHome(), ".ecm")
