...
type Metadata struct {
	...
	Region          string      `json:"region,omitempty" yaml:"region,omitempty"`                                    //add by edgego
	UpdatedAt       int64       `json:"updated-at,omitempty" yaml:"updated-at,omitempty" gorm:"autoUpdateTime:nano"` //add by edgego
	//CreatedAt       int64       `json:"created-at,omitempty" yaml:"created-at,omitempty" gorm:"autoCreateTime:nano"` //add by edgego
}
